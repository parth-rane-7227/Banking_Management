					...
					<div class=" form-grids row form-grids-right">
						...
						<table class="table table-bordered"> 
								...
								{   
									...
									String acnum= request.getParameter("anumber");
									String pass = request.getParameter("apassword");
									
									Connection con = ConnectDB.getConnect();
									PreparedStatement ps1 = con.prepareStatement("select * from account where AccNo=? and Password=?");
						...
						<a href="ViewUser.html"><button class="button" type="submit">Back</button></a> 
